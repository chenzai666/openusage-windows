...
client_id=<public Antigravity desktop client id>
&client_secret=<public Antigravity desktop client secret>
...
The same public OAuth client pair is embedded in the Antigravity app bundle (not a private server secret).
